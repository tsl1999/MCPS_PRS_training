#!/bin/bash
#SBATCH --job-name="qc-fulltrain"
#SBATCH --mem=100GB
#SBATCH --output=/well/emberson/users/hma817/projects/MCPS_PRS_training/03_GWAS/01_qc_variants/out/qc_variant_CAD_EPA_80_fulltrain.out
...
PHENODIR=/well/emberson/users/hma817/projects/MCPS_PRS_training/Training_data
...
python $WORKFLOWDIR/02.1_extract-qc-variants.py binary \
  $PHENODIR/cases_training_CAD_EPA_80.txt $PHENODIR/qc_variants
